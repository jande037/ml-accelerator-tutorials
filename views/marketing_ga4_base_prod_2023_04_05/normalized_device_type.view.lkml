view: normalized_device_type {
  sql_table_name: `ryancustomerhosted.marketing_ga4_base_prod_views.normalized_device_type`
    ;;
  drill_fields: [normalized_device_type_id]
  ...
  dimension: normalized_language {
    type: string
    sql: ${TABLE}.normalized_language ;;
  }

  measure: count {
    type: count
    drill_fields: [normalized_device_type_id, device_mobile_model_name, device_mobile_brand_name, event.count]
  }
}
