...
explore: public_obf_event {
  hidden: yes

  join: public_obf_event__items {
    view_label: "Public Obf Event: Items"
    sql: LEFT JOIN UNNEST(${public_obf_event.items}) as public_obf_event__items ;;
    relationship: one_to_many
  }

  join: public_obf_event__event_params {
    view_label: "Public Obf Event: Event Params"
    sql: LEFT JOIN UNNEST(${public_obf_event.event_params}) as public_obf_event__event_params ;;
    relationship: one_to_many
  }

  join: public_obf_event__user_properties {
    view_label: "Public Obf Event: User Properties"
    sql: LEFT JOIN UNNEST(${public_obf_event.user_properties}) as public_obf_event__user_properties ;;
    relationship: one_to_many
  }
}

view: public_obf_event {
  sql_table_name: `ryancustomerhosted.marketing_ga4_base_prod_views.public_obf_event`
    ;;
...
view: public_obf_event__items {
  ...
  dimension: public_obf_event__items {
    type: string
    hidden: yes
    sql: public_obf_event__items ;;
  }
...
view: public_obf_event__event_params {
  dimension: key {
    type: string
    sql: key ;;
  }

  dimension: public_obf_event__event_params {
    type: string
    hidden: yes
    sql: public_obf_event__event_params ;;
  }
...
view: public_obf_event__user_properties {
  dimension: key {
    type: number
    sql: key ;;
  }

  dimension: public_obf_event__user_properties {
    type: string
    hidden: yes
    sql: public_obf_event__user_properties ;;
  }
